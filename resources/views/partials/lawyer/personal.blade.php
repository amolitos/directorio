<div class="flex flex-col items-center gap-4 text-center">
    <div class="h-72 w-72 flex justify-center items-center"
        ...
        <img src="{{ $lawyer->profile->photo ? '/storage/' . $lawyer->profile->photo : '/images/user.jpg' }}"
            alt="Abogado" class="h-52 w-52 object-contain rounded-full select-none mr-2 mb-3">
    </div>
    <div>
